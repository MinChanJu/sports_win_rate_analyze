variables = {
    "팀 및 경기 관련 변수 (Team & Game Variables)": {
        "TeamName": "팀명 (Team Name)",
        "AST": "어시스트 (Assist)",
        ...
        "BF": "벤치 반칙 (Bench Foul)",
        "FoulOut": "반칙 퇴장 (Foul Out)",
        "TeamReb": "팀 리바운드 (Team Rebound)",
        "TeamF_PG": "팀 경기당 반칙 (Team Fouls Per Game)",
        "TO": "턴오버 (Turnover)",
    ...
    "슛 관련 변수 (Shooting Variables)": {
        ...
        "2PA": "2점슛 시도 (2-Point Shot Attempted)",
        "FGA": "필드골(야투) 시도 (Field Goal Attempted)",
